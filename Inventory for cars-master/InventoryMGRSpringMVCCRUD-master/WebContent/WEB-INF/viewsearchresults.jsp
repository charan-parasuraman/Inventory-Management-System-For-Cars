...
<title>Cars4..You Search Results</title>
...
<body>
	<div class="index-main">
		...
		<h1 class="center">Look what we Found</h1>
			...
			<table class="table-hover table-responsive">
				<thead class="thead-inverse">
					<tr>
						...
						<th class="spacing">Transmission</th>
				...
				<tbody>
					...
					<tr>
						...
						<td class="spacing"><span class="dollars">${product.msrp}<type = "currency"/> </span></td>
						<td class="spacing"><span class="dollars">${product.unitcost}<type = "currency"/></span></td>
